...
},
{
...
},
  {
    ...
    containerStyle: {
      ...
      "justify-content": "flex-start", "width": "980px", "height": "580px",
      "background": "#1a1a2e", "border-radius": "16px",
      "box-shadow": "0 14px 40px rgba(0,0,0,0.5), 0 0 0 2px #533483",
      "overflow": "hidden", "box-sizing": "border-box",
      "position": "absolute", "z-index": "100",
    },
    layout: { type: "split", position: "left" },
    texts: {
      headline: "Spin the Slots & Win Big!",
      description: "Enter your email and get one free spin. Match 3 symbols to reveal your exclusive discount!",
      disclaimer: "One spin per email. Coupon valid for 15 minutes after winning.",
    },
    text_styles: {
      headline:    { "font-family": "Arial", "font-size": "26px", "text-align": "center", "font-weight": "bold",   "font-style": "normal", "text-decoration": "none", "color": "#f5a623" },
      description: { "font-family": "Arial", "font-size": "15px", "text-align": "center", "font-weight": "normal", "font-style": "normal", "text-decoration": "none", "color": "#ffffff" },
      disclaimer:  { "font-family": "Arial", "font-size": "12px", "text-align": "center", "font-weight": "normal", "font-style": "italic", "text-decoration": "none", "color": "#aaaaaa" },
    },
    close_button: {
      type: "icon", position: "top-right",
      style: "position:absolute; right:12px; top:10px; width:32px; height:32px; background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,255,0.2); border-radius:50%; color:#ffffff; font-size:18px; display:flex; align-items:center; justify-content:center; cursor:pointer; z-index:10;",
    },
    game_styles: {
      game_svg: "display:block; box-sizing:border-box; max-width:100%; max-height:100%; width:auto; height:auto; flex-shrink:1;",
      game_svg_area: "height: 80%",
      ...
      gameOpacity: 0,
      game_svg_text: { "font-family": "Arial", "font-size": "24px" },
      left:  { game: "order:1; flex:0 0 55%; width:55%; max-width:55%; height:100%; align-self:center; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; min-height:0; position:relative; overflow:hidden;", game_inner: "width:100%; height:100%; min-height:0; flex:1 1 auto; display:flex; align-items:center; justify-content:center; box-sizing:border-box; overflow:hidden; padding:12px; height:100%;" },
      right: { game: "order:2; flex:0 0 55%; width:55%; max-width:55%; height:100%; align-self:center; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; min-height:0; position:relative; overflow:hidden;", game_inner: "width:100%; height:100%; min-height:0; flex:1 1 auto; display:flex; align-items:center; justify-content:center; box-sizing:border-box; overflow:hidden; padding:12px; height:100%;" },
      top:   { game: "order:1; flex:0 0 auto; width:100%; max-width:100%; align-self:center; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; min-height:0; position:relative; overflow:hidden;", game_inner: "width:100%; height:100%; min-height:0; flex:1 1 auto; display:flex; align-items:center; justify-content:center; box-sizing:border-box; overflow:hidden; padding:12px; height:100%;" },
    },
    content_styles: JSON.parse(JSON.stringify(default_content_styles)),
    image_styles: {
      left:  { image: "display:flex; flex-direction:column; flex:0 0 0; width:0; max-width:0; min-width:0; overflow:hidden; padding:0; margin:0;", image_inner: "display:none; width:0; height:0; overflow:hidden;" },
      top:   { image: "display:flex; flex-direction:column; flex:0 0 0; width:0; max-width:0; min-width:0; overflow:hidden; padding:0; margin:0;", image_inner: "display:none; width:0; height:0; overflow:hidden;" },
      right: { image: "display:flex; flex-direction:column; flex:0 0 0; width:0; max-width:0; min-width:0; overflow:hidden; padding:0; margin:0;", image_inner: "display:none; width:0; height:0; overflow:hidden;" },
    },
    input_fields: defaultGamingTemplateInputFields(),
    gameColors: {
      "--slot-bg": "#1a1a2e", "--slot-reel-bg": "#0f3460", "--slot-accent": "#e94560",
      "--slot-gold": "#f5a623", "--slot-text": "#ffffff", "--slot-btn": "#e94560",
      "--slot-btn-text": "#ffffff", "--slot-frame": "#16213e", "--slot-highlight": "#533483",
    },
    background_image: { path: "", style: "" },
    image: { path: "", style: "" },
    top_image: { path: "", style: "" },
    bottom_image: { path: "", style: "" },
  },
  {
    id: 301,
    name: "Scratch Card — Steam Blue",
    categories: ["Modern", "Colorful"],
    popup_type: "gaming",
    hasGame: true,
    thumbnail: "",
    ...
    containerStyle: {
      "display": "flex", "flex-direction": "column", "align-items": "stretch",
      "justify-content": "flex-start", "width": "980px", "height": "580px",
      "background": "#1b2838", "border-radius": "16px",
      "box-shadow": "0 14px 40px rgba(0,0,0,0.5), 0 0 0 2px #4c6b8a",
      "overflow": "hidden", "box-sizing": "border-box",
      "position": "absolute", "z-index": "100",
    },
    layout: { type: "split", position: "left" },
    texts: {
      headline: "Scratch & Win a Special Offer!",
      description: "Enter your email to reveal a hidden discount. Scratch the card to uncover your exclusive coupon!",
      disclaimer: "One scratch per email. Prize valid for 24 hours after reveal.",
    },
    text_styles: {
      headline:    { "font-family": "Arial", "font-size": "26px", "text-align": "center", "font-weight": "bold",   "font-style": "normal", "text-decoration": "none", "color": "#66c0f4" },
      description: { "font-family": "Arial", "font-size": "15px", "text-align": "center", "font-weight": "normal", "font-style": "normal", "text-decoration": "none", "color": "#ffffff" },
      disclaimer:  { "font-family": "Arial", "font-size": "12px", "text-align": "center", "font-weight": "normal", "font-style": "italic", "text-decoration": "none", "color": "#aaaaaa" },
    },
    close_button: {
    ...
    game_styles: {
      game_svg: "display:block; box-sizing:border-box; max-width:100%; max-height:100%; width:auto; height:auto; flex-shrink:1;",
      game_svg_area: "height: 80%",
      gameBackground: "#1b2838",
      gameOpacity: 0,
      game_svg_text: { "font-family": "Arial", "font-size": "24px" },
      left:  { game: "order:1; flex:0 0 50%; width:50%; max-width:50%; height:100%; align-self:center; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; min-height:0; position:relative; overflow:hidden;", game_inner: "width:100%; height:100%; min-height:0; flex:1 1 auto; display:flex; align-items:center; justify-content:center; box-sizing:border-box; overflow:hidden; padding:12px; height:100%;" },
      right: { game: "order:2; flex:0 0 50%; width:50%; max-width:50%; height:100%; align-self:center; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; min-height:0; position:relative; overflow:hidden;", game_inner: "width:100%; height:100%; min-height:0; flex:1 1 auto; display:flex; align-items:center; justify-content:center; box-sizing:border-box; overflow:hidden; padding:12px; height:100%;" },
      top:   { game: "order:1; flex:0 0 auto; width:100%; max-width:100%; align-self:center; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; min-height:0; position:relative; overflow:hidden;", game_inner: "width:100%; height:100%; min-height:0; flex:1 1 auto; display:flex; align-items:center; justify-content:center; box-sizing:border-box; overflow:hidden; padding:12px; height:100%;" },
    },
    content_styles: JSON.parse(JSON.stringify(default_content_styles)),
    image_styles: {
    ...
    input_fields: defaultGamingTemplateInputFields(),
    gameColors: {
      "--scratch-bg": "#1b2838", "--scratch-card-bg": "#2a475e", "--scratch-accent": "#66c0f4",
      "--scratch-gold": "#c7b27a", "--scratch-text": "#ffffff", "--scratch-panel": "#1b2838",
      "--scratch-highlight": "#4c6b8a", "--scratch-btn": "#66c0f4", "--scratch-btn-text": "#1b2838",
    },
    background_image: { path: "", style: "" },
    image: { path: "", style: "" },
    top_image: { path: "", style: "" },
