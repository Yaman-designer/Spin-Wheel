const wheelSVG=`<svg id="katman_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-250 0 3650 3128.05">
  <defs>
    <style>
      ...
      /* Pin: transform attribute only on the g element — dual transform (CSS+attribute) shifts the pin */
...
const slotMachineSVG = `<svg id="slot-machine-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 500" style="--slot-bg:#1a1a2e; --slot-reel-bg:#0f3460; --slot-accent:#e94560; --slot-gold:#f5a623; --slot-text:#ffffff; --slot-btn:#e94560; --slot-btn-text:#ffffff; --slot-frame:#16213e; --slot-highlight:#533483;">
  <rect width="400" height="500" rx="20" ry="20" fill="var(--slot-bg)"/>
  <rect x="4" y="4" width="392" height="492" rx="18" ry="18" fill="none" stroke="var(--slot-frame)" stroke-width="8"/>
  <rect x="20" y="20" width="360" height="80" rx="10" ry="10" fill="var(--slot-highlight)"/>
  <text x="200" y="55" text-anchor="middle" font-family="Arial,sans-serif" font-weight="bold" font-size="24" fill="var(--slot-gold)">LUCKY SLOTS</text>
  <text x="200" y="85" text-anchor="middle" font-family="Arial,sans-serif" font-size="14" fill="var(--slot-text)">Spin to Win!</text>
  <rect x="20" y="115" width="155" height="38" rx="5" ry="5" fill="rgba(0,0,0,0.5)"/>
  <text x="30" y="133" font-family="Arial,sans-serif" font-size="11" fill="var(--slot-gold)">CREDITS</text>
  <text x="30" y="149" font-family="Arial,sans-serif" font-size="14" font-weight="bold" fill="var(--slot-text)">100</text>
  <rect x="225" y="115" width="155" height="38" rx="5" ry="5" fill="rgba(0,0,0,0.5)"/>
  <text x="235" y="133" font-family="Arial,sans-serif" font-size="11" fill="var(--slot-gold)">WINS</text>
  <text x="235" y="149" font-family="Arial,sans-serif" font-size="14" font-weight="bold" fill="var(--slot-text)">0</text>
  <rect x="20" y="165" width="360" height="175" rx="10" ry="10" fill="rgba(0,0,0,0.5)"/>
  <line x1="20" y1="252" x2="380" y2="252" stroke="var(--slot-accent)" stroke-width="2.5" stroke-dasharray="6,3" opacity="0.9"/>
  <rect x="30" y="175" width="100" height="155" rx="8" ry="8" fill="var(--slot-reel-bg)"/>
  <text x="80" y="262" text-anchor="middle" font-size="42" font-family="Arial,sans-serif">&#127826;</text>
  <rect x="150" y="175" width="100" height="155" rx="8" ry="8" fill="var(--slot-reel-bg)"/>
  <text x="200" y="262" text-anchor="middle" font-size="42" font-family="Arial,sans-serif">&#128142;</text>
  <rect x="270" y="175" width="100" height="155" rx="8" ry="8" fill="var(--slot-reel-bg)"/>
  <text x="320" y="262" text-anchor="middle" font-size="42" font-family="Arial,sans-serif">&#127819;</text>
  <rect x="322" y="244" width="58" height="16" rx="4" ry="4" fill="var(--slot-accent)"/>
  <text x="351" y="255" text-anchor="middle" font-family="Arial,sans-serif" font-size="8" font-weight="bold" fill="var(--slot-btn-text)">WIN LINE</text>
  <circle cx="40" cy="358" r="7" fill="var(--slot-accent)" opacity="0.9"/>
  <circle cx="65" cy="358" r="7" fill="var(--slot-gold)" opacity="0.9"/>
  <circle cx="90" cy="358" r="7" fill="var(--slot-accent)" opacity="0.9"/>
  <circle cx="310" cy="358" r="7" fill="var(--slot-gold)" opacity="0.9"/>
  <circle cx="335" cy="358" r="7" fill="var(--slot-accent)" opacity="0.9"/>
  <circle cx="360" cy="358" r="7" fill="var(--slot-gold)" opacity="0.9"/>
  <rect x="100" y="372" width="200" height="56" rx="28" ry="28" fill="var(--slot-btn)"/>
  <text x="200" y="408" text-anchor="middle" font-family="Arial,sans-serif" font-weight="bold" font-size="22" fill="var(--slot-btn-text)">SPIN</text>
  <text x="200" y="462" text-anchor="middle" font-family="Arial,sans-serif" font-size="12" fill="var(--slot-text)" opacity="0.6">Match 3 symbols to win a prize!</text>
  <text x="200" y="483" text-anchor="middle" font-family="Arial,sans-serif" font-size="11" fill="var(--slot-gold)" opacity="0.8">&#9733; &#9733; &#9733;</text>
</svg>`;

const scratchCardSVG = `<svg id="scratch-card-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 480" style="--scratch-bg:#1b2838; --scratch-card-bg:#2a475e; --scratch-accent:#66c0f4; --scratch-gold:#c7b27a; --scratch-text:#ffffff; --scratch-panel:#1b2838; --scratch-highlight:#4c6b8a; --scratch-btn:#66c0f4; --scratch-btn-text:#1b2838;">
  <defs>
    <pattern id="scratchPattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
      <rect width="20" height="20" fill="#a8a8a8"/>
      <rect x="0" y="0" width="10" height="10" fill="#c0c0c0"/>
      <rect x="10" y="10" width="10" height="10" fill="#c0c0c0"/>
      <rect x="5" y="5" width="10" height="10" fill="#b0b0b0" opacity="0.5"/>
    </pattern>
    <linearGradient id="scratchCardGrad" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="var(--scratch-card-bg)"/>
      <stop offset="100%" stop-color="var(--scratch-bg)"/>
    </linearGradient>
  </defs>
  <rect width="400" height="480" rx="20" ry="20" fill="url(#scratchCardGrad)"/>
  <rect x="4" y="4" width="392" height="472" rx="18" ry="18" fill="none" stroke="var(--scratch-highlight)" stroke-width="3"/>
  <rect x="20" y="20" width="360" height="70" rx="10" ry="10" fill="var(--scratch-highlight)"/>
  <text x="200" y="50" text-anchor="middle" font-family="Arial,sans-serif" font-weight="bold" font-size="22" fill="var(--scratch-accent)">WIN &amp; REVEAL</text>
  <text x="200" y="76" text-anchor="middle" font-family="Arial,sans-serif" font-size="13" fill="var(--scratch-text)">Reveal your hidden prize!</text>
  <rect x="20" y="104" width="360" height="240" rx="10" ry="10" fill="rgba(0,0,0,0.4)"/>
  <rect x="30" y="114" width="105" height="105" rx="8" ry="8" fill="var(--scratch-card-bg)"/>
  <text x="82" y="172" text-anchor="middle" font-size="36" font-family="Arial,sans-serif">&#127873;</text>
  <rect x="147" y="114" width="106" height="105" rx="8" ry="8" fill="var(--scratch-card-bg)"/>
  <text x="200" y="172" text-anchor="middle" font-size="36" font-family="Arial,sans-serif">&#128176;</text>
  <rect x="265" y="114" width="105" height="105" rx="8" ry="8" fill="var(--scratch-card-bg)"/>
  <text x="317" y="172" text-anchor="middle" font-size="36" font-family="Arial,sans-serif">&#11088;</text>
  <rect x="30" y="229" width="105" height="105" rx="8" ry="8" fill="var(--scratch-card-bg)"/>
  <text x="82" y="287" text-anchor="middle" font-size="36" font-family="Arial,sans-serif">&#127808;</text>
  <rect x="147" y="229" width="106" height="105" rx="8" ry="8" fill="var(--scratch-highlight)" stroke="var(--scratch-accent)" stroke-width="2"/>
  <text x="200" y="275" text-anchor="middle" font-family="Arial,sans-serif" font-weight="bold" font-size="14" fill="var(--scratch-accent)">20% OFF</text>
  <text x="200" y="294" text-anchor="middle" font-family="Arial,sans-serif" font-size="11" fill="var(--scratch-text)">Code: SCR20</text>
  <rect x="265" y="229" width="105" height="105" rx="8" ry="8" fill="var(--scratch-card-bg)"/>
  <text x="317" y="287" text-anchor="middle" font-size="36" font-family="Arial,sans-serif">&#127919;</text>
  <rect x="20" y="104" width="360" height="240" rx="10" ry="10" fill="url(#scratchPattern)" opacity="0.88"/>
  <ellipse cx="90" cy="185" rx="28" ry="16" fill="#d8d8d8" opacity="0.5" transform="rotate(-15 90 185)"/>
  <ellipse cx="215" cy="162" rx="32" ry="13" fill="#d0d0d0" opacity="0.5" transform="rotate(10 215 162)"/>
  <ellipse cx="320" cy="200" rx="22" ry="20" fill="#d8d8d8" opacity="0.5" transform="rotate(-5 320 200)"/>
  <text x="200" y="365" text-anchor="middle" font-family="Arial,sans-serif" font-size="13" fill="var(--scratch-gold)">Match 3 symbols to WIN!</text>
  <rect x="80" y="382" width="240" height="52" rx="26" ry="26" fill="var(--scratch-btn)"/>
  <text x="200" y="414" text-anchor="middle" font-family="Arial,sans-serif" font-weight="bold" font-size="17" fill="var(--scratch-btn-text)">SCRATCH NOW</text>
  <text x="200" y="452" text-anchor="middle" font-family="Arial,sans-serif" font-size="11" fill="var(--scratch-text)" opacity="0.6">One scratch per email address</text>
  <text x="200" y="470" text-anchor="middle" font-family="Arial,sans-serif" font-size="12" fill="var(--scratch-gold)" opacity="0.9">&#10022; &#10022; &#10022;</text>
</svg>`;
...
const games = [
      {
        ...
        game: wheelSVG,
        gameRewards: [
          { text: '50% OFF', weight: 9, couponCode: 'SAVE50', hasReward: true, sliceText: 'slice2-text1' },
          { text: 'Sorry', weight: 0, couponCode: '', hasReward: false, sliceText: 'slice1-text1' },
          { text: '30% OFF', weight: 26, couponCode: 'SAVE30', hasReward: true, sliceText: 'slice2-text2' },
          { text: 'Almost', weight: 0, couponCode: '', hasReward: false, sliceText: 'slice1-text2' },
          { text: '70% OFF', weight: 5, couponCode: 'SAVE70', hasReward: true, sliceText: 'slice2-text3' },
          { text: 'Next time', weight: 0, couponCode: '', hasReward: false, sliceText: 'slice1-text3' },
          { text: '40% OFF', weight: 17, couponCode: 'SAVE40', hasReward: true, sliceText: 'slice4-text1' },
          { text: 'Nope', weight: 0, couponCode: '', hasReward: false, sliceText: 'slice3-text1' },
          { text: '20% OFF', weight: 34, couponCode: 'SAVE20', hasReward: true, sliceText: 'slice4-text2' },
          { text: 'No luck today', weight: 0, couponCode: '', hasReward: false, sliceText: 'slice3-text2' },
          { text: '60% OFF', weight: 9, couponCode: 'SAVE60', hasReward: true, sliceText: 'slice4-text3' },
          { text: 'Nothing', weight: 0, couponCode: '', hasReward: false, sliceText: 'slice3-text3' }
        ],
        gameColors: {
          '--primary-color': '#00C39A',
          '--secondary-color': '#808080',
      ...
      },
      {
        ...
        game: slotMachineSVG,
        gameRewards: [
          { text: '50% OFF',       weight: 8,  couponCode: 'SLOT50',  hasReward: true  },
          { text: 'Sorry',         weight: 0,  couponCode: '',         hasReward: false },
          { text: '30% OFF',       weight: 20, couponCode: 'SLOT30',  hasReward: true  },
          { text: 'No luck',       weight: 0,  couponCode: '',         hasReward: false },
          { text: '70% OFF',       weight: 5,  couponCode: 'SLOT70',  hasReward: true  },
          { text: 'Try again',     weight: 0,  couponCode: '',         hasReward: false },
          { text: 'Free Shipping', weight: 25, couponCode: 'SHIPFREE', hasReward: true  },
          { text: 'Nothing',       weight: 0,  couponCode: '',         hasReward: false },
          { text: '20% OFF',       weight: 30, couponCode: 'SLOT20',  hasReward: true  },
          { text: 'Miss',          weight: 0,  couponCode: '',         hasReward: false },
          { text: '10% OFF',       weight: 12, couponCode: 'SLOT10',  hasReward: true  },
        ],
        gameColors: {
          '--slot-bg':        '#1a1a2e',
          '--slot-reel-bg':   '#0f3460',
          ...
          '--slot-text':      '#ffffff',
          '--slot-btn':       '#e94560',
          '--slot-btn-text':  '#ffffff',
          '--slot-frame':     '#16213e',
          '--slot-highlight': '#533483',
        },
      },
      {
        id: 3,
        ...
        game: scratchCardSVG,
        gameRewards: [
          { text: '20% OFF',       weight: 30, couponCode: 'SCR20',   hasReward: true  },
          { text: 'Sorry',         weight: 0,  couponCode: '',         hasReward: false },
          { text: '40% OFF',       weight: 15, couponCode: 'SCR40',   hasReward: true  },
          { text: 'No luck',       weight: 0,  couponCode: '',         hasReward: false },
          { text: '60% OFF',       weight: 8,  couponCode: 'SCR60',   hasReward: true  },
          { text: 'Try again',     weight: 0,  couponCode: '',         hasReward: false },
          { text: 'Free Shipping', weight: 25, couponCode: 'SCRSHIP',  hasReward: true  },
          { text: 'Nothing',       weight: 0,  couponCode: '',         hasReward: false },
          { text: '10% OFF',       weight: 22, couponCode: 'SCR10',   hasReward: true  },
        ],
        gameColors: {
          '--scratch-bg':        '#1b2838',
          '--scratch-card-bg':   '#2a475e',
          '--scratch-accent':    '#66c0f4',
          '--scratch-gold':      '#c7b27a',
          '--scratch-text':      '#ffffff',
          '--scratch-panel':     '#1b2838',
          '--scratch-highlight': '#4c6b8a',
          '--scratch-btn':       '#66c0f4',
          '--scratch-btn-text':  '#1b2838',
        },
      }
    ];
